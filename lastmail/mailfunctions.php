<?php
	...
	//Domain settings
	$ROOT_URL = "http://wmcode.nl/code/projects/lastmail/";
	
	
  //include_once "mailer.php";

  $SENDERADDR = '"Azrael of LastMail" <azrael@wmmusic.nl>';
...
function sendActivityCheckMail($user, $fromsamedir=false){
	...
	$message = str_replace('{{UPDATER_IMAGE}}',$ROOT_URL . 'updaterimage.php?ukey='. $user['ukey'] , $message);
